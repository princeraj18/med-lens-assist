  ...
  return <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {features.map(feature => <Card key={feature.id} className="group hover:shadow-xl transition-all duration-300 border-0 bg-card/60 backdrop-blur">
              ...
              <CardContent className="text-center">
                <Button onClick={() => navigate(feature.path)} className="w-full bg-gradient-to-r from-primary to-accent hover:shadow-lg transition-all duration-300" size="lg">
