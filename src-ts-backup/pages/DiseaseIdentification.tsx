  ...
  const capturePhoto = () => {
    if (videoRef.current && canvasRef.current) {
      ...
      if (ctx) {
        ...
        canvas.toBlob((blob) => {
          if (blob) {
            const file = new File([blob], 'captured-symptom.jpg', { type: 'image/jpeg' });
    ...
    try {
      ...
      const mockAnalysis = {
        ...
        alternativeConditions: [
          ...
          { name: "Contact Dermatitis", confidence: 52 },
          { name: "Psoriasis", confidence: 34 }
        ],
        symptoms: [
        ...
        recommendations: [
          ...
          "Consider topical corticosteroids if recommended by doctor"
        ],
        whenToSeeDoctor: [
              ...
              {!isCameraActive && !previewUrl && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Button
                    ...
                    className="h-24 bg-gradient-to-r from-orange-500 to-red-500"
                    size="lg"
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-b pb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge className={getUrgencyColor(analysisResult.urgency)}>
                        {analysisResult.urgency === 'routine' ? 'Routine Care' : 
                         analysisResult.urgency === 'urgent' ? 'Urgent Care' : 'Emergency'}
                      </Badge>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {analysisResult.alternativeConditions.map((condition: any, index: number) => (
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-yellow-700">
                      {analysisResult.whenToSeeDoctor.map((item: string, index: number) => (
